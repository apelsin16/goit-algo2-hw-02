...
def optimize_printing(print_jobs: List[Dict], constraints: Dict) -> Dict:
    ...
    # Сортування: пріоритет зростає (1 — найвищий), далі — за часом друку
    ...
    while not all(used):
        ...
        for i, job in enumerate(jobs):
            if not used[i] and batch_count < printer.max_items and batch_volume + job.volume <= printer.max_volume:
                batch.append(job)
